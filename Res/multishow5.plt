...
set terminal GNUTERM size 1280,720
set encoding utf8
...
unset rtics
unset mrtics
set key bmargin center opaque horizontal Left noinvert reverse width 0 height 1 samplen 4 spacing 1 enhanced textcolor '#404040' font ',10' nobox maxrows auto maxcols auto
...
#==============================================================================
plot \
    'plot35.dat' index 0 with points linestyle 1 linewidth 2, \
    'plot35.dat' index 1 with points linestyle 2 linewidth 2
